...
public class HashSetTester
{
	...
	{	
		...
		System.out.println("size after alladds succeed: " + hset.size());
		...
		while (infile.ready()) 
			if ( hset.add(infile.readLine()) ) 
					...
					System.out.println("WRONGLY ADDED WORD BEFORE " + infile.readLine());
					break;}
		infile.close();

		System.out.println("size after alladds fail: " + hset.size());
		...
		//System.out.println(removesFailed);
		//System.out.println("size: after allremoves succeed: " + hset.size());
		...
		//System.out.println("size: after allremoves fail: " + hset.size());
