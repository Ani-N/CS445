...
public class ArrBag<T>
{
	...
	public void clear()
	{
		theArray = (T[]) new Object[INITIAL_CAPACITY];
	...
	private void upSize()
	{
		...
		T[] tempArray = (T[]) new Object[this.theArray.length*2];
	...
	public String toString()
	{
		...
		for(int i = 0; i<count; i++) toString = toString + get(i) + " " ;
	...
	{
		ArrBag<T> intersection = new ArrBag<T>( this.size()); // REPLACE WITH YOUR CODE
		for(int i = 0; i < this.size(); i++)
		{
